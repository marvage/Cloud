//An Arduino sketch to simulate lightning//
//Note: this sketch is based on https://github.com/watsonboyett/lightning/ //

#include <Adafruit_NeoPixel.h>

#define NEOPIXEL_PIN (6)    // data pin of neopixel strip
#define SECTION_LEN (2)     // number of LEDs to be grouped as one
#define NUM_SECTIONS (10)   // number of LED groups
#define NUM_PIXELS (20)    // total number of LEDS
...
void loop()
{
  ...
  lightning();
  int delay_long = random(1000, 5000);
  delay(delay_long);
}
...
const int seq_count = 15;  // the maximum "duration" of each lightning sequence
